  ...
  const transactions = [
    {
      ...
      amount: `₹${(2500 * USD_TO_INR).toLocaleString()}`,
      tokens: "125 LAPT",
      date: "2025-01-06",
      time: "14:30",
      status: "completed",
    ...
    },
    {
      ...
      amount: `₹${(1800 * USD_TO_INR).toLocaleString()}`,
      tokens: "90 CPMT",
      date: "2025-01-05",
      time: "09:15",
      status: "completed",
    ...
    },
    {
      ...
      amount: `₹${(150 * USD_TO_INR).toLocaleString()}`,
      tokens: "75 IWTX",
      date: "2025-01-04",
      time: "16:45",
      status: "completed",
    ...
    },
    {
      ...
      amount: `₹${(3200 * USD_TO_INR).toLocaleString()}`,
      tokens: "160 RCCA",
      date: "2025-01-03",
      time: "11:20",
      status: "pending",
      ...
      <div className="space-y-4">
        {filteredTransactions?.length === 0 ? (
          ...
          filteredTransactions?.map((transaction) => (
            <div
              key={transaction?.id}
              className="flex items-center justify-between p-4 bg-muted/30 rounded-lg hover:bg-muted/50 transition-smooth duration-150"
            >
              <div className="flex items-center space-x-4">
                <div
                  className={`flex items-center justify-center w-10 h-10 rounded-lg bg-background ${getTransactionColor(
                    transaction?.type
                  )}`}
                >
                  <Icon
