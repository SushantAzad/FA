...
const PropertyLocation = ({ property }) => {
  const locationDetails = {
    ...
    coordinates: property?.coordinates || { lat: 40.7128, lng: -74.006 },
  };
        ...
        <div className="space-y-4">
          <div className="p-4 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              Property values in {locationDetails?.neighborhood} have increased
              by 8.2% over the past year, outperforming the city average of
              6.1%. The area shows strong rental demand with low vacancy rates.
            </p>
          </div>
          ...
          <div className="p-4 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              Young professionals and families make up the majority of
              residents. Median household income is 15% above city average, with
          ...
          <div className="p-4 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              Several new commercial and residential developments are planned
              for the area, including a new shopping center and improved public
