...
const LegalDocuments = ({ property }) => {
  ...
  const handleDownload = async (docId, docName) => {
    ...
    // Trigger download of mock document
    const link = document.createElement("a");
    link.href = "/mock-legal-document.pdf";
    ...
    <div className="bg-card rounded-lg p-6 shadow-elevation-2">
      ...
      <div className="mt-6 p-4 bg-muted/30 border border-border rounded-lg">
        <div className="flex items-start space-x-3">
          ...
          />
          <div className="text-xs text-muted-foreground">
            <strong>Legal Disclaimer:</strong> These documents contain important
            information about the investment opportunity, including risks and
            fees. Please read all documents carefully before investing. Past
