...
const PortfolioManagement = () => {
  ...
  const USD_TO_INR = 83;
  const totalValue =
    portfolioData?.reduce((sum, holding) => sum + holding?.value, 0) *
    USD_TO_INR;
  const totalPurchaseValue =
    portfolioData?.reduce((sum, holding) => sum + holding?.purchaseValue, 0) *
    USD_TO_INR;
  ...
  const totalDividends =
    portfolioData?.reduce((sum, holding) => sum + holding?.dividends, 0) *
    USD_TO_INR;
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Track your investments, analyze performance, and optimize your
