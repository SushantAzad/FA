...
const DividendTracker = ({
  ...
  const filteredDividends = dividendData?.filter((dividend) => {
    ...
    const matchesStatus =
      statusFilter === "all" || dividend?.status === statusFilter;
        ...
        <div className="p-4 bg-accent/5 border-b border-border">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-muted-foreground">
                {formatCurrency(nextDividend?.amount)} expected on{" "}
                {formatDate(nextDividend?.date)}
              </div>
            </div>
            <Button
              variant="outline"
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground mt-1">
                      {dividend?.tokens?.toLocaleString()} tokens •{" "}
                      {dividend?.yieldRate}% yield
                    </div>
                  </div>
                </div>
